...
{
    if ( strcmp( c_name, "void" ) == 0 )
        return "void";
    if ( strcmp( c_name, "bool" ) == 0 )
        return "bool";
    if ( strcmp( c_name, "char" ) == 0 )
        return "char";
    if ( strcmp( c_name, "int8_t" ) == 0 )
        return "i8";
    if ( strcmp( c_name, "int16_t" ) == 0 )
        return "i16";
    if ( strcmp( c_name, "int32_t" ) == 0 )
        return "i32";
    if ( strcmp( c_name, "int64_t" ) == 0 )
        return "i64";
    if ( strcmp( c_name, "uint8_t" ) == 0 )
        return "u8";
    if ( strcmp( c_name, "uint16_t" ) == 0 )
        return "u16";
    if ( strcmp( c_name, "uint32_t" ) == 0 )
        return "u32";
    if ( strcmp( c_name, "uint64_t" ) == 0 )
        return "u64";
    if ( strcmp( c_name, "float" ) == 0 )
        return "f32";
    if ( strcmp( c_name, "double" ) == 0 )
        return "f64";
    if ( strcmp( c_name, "const char*" ) == 0 )
        return "cstr";
